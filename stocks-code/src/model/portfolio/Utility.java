...
public class  Utility {
   ...
   */
  public static <T extends PortfolioData> String getLatestDate(Map<String, T> pfData) {
   ...
   */
  public static <T extends PortfolioData> String getOldestDate(Map<String, T> pfData) {
    ArrayList<String> sortedDates = new ArrayList<>(pfData.keySet());
    if (sortedDates.isEmpty()) {
      return "No data found to sort";
    }
