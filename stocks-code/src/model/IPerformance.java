...
public interface IPerformance {
   ...
   */
  String showPerformanceByMonth(Map<String, PortfolioData> pfData, String startDate, String endDate);
  /**
   ...
   */
  String showPerformanceByQuarter(Map<String, PortfolioData> pfData, String startDate, String endDate);
  /**
   ...
   */
  String showPerformanceByHalfYear(Map<String, PortfolioData> pfData, String startDate, String endDate);
  /**
